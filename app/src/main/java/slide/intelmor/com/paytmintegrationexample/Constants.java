package slide.intelmor.com.paytmintegrationexample;
...
public class Constants {
    ...
    public static final String M_ID = "Intelm31155832720856"; //Paytm Merchand Id we got it in paytm credentials
